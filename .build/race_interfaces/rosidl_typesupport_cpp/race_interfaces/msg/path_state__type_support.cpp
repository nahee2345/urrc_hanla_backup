...
static const _PathState_type_support_symbol_names_t _PathState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, race_interfaces, msg, PathState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, race_interfaces, msg, PathState)),
  }
};
...
{
  return &::race_interfaces::msg::rosidl_typesupport_cpp::PathState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, race_interfaces, msg, PathState)() {
  return get_message_type_support_handle<race_interfaces::msg::PathState>();
}
