...
bool race_interfaces__msg__path_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("race_interfaces.msg._path_state.PathState", full_classname_dest, 41) == 0);
  }
  race_interfaces__msg__PathState * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of PathState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("race_interfaces.msg._path_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PathState");
